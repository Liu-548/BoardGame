...
// (biến thể riêng của dự án, xem docs/roadmap/LO-TRINH.md).
...
// biến thể 8 người, xem docs/roadmap/LO-TRINH.md: giống 7 người mặc định, cộng thêm 1 Kẻ
...
// Biến thể 2 người (xem docs/roadmap/LO-TRINH.md) — KHÔNG chia vai, `role: null` cho cả 2
...
// Biến thể 3 người (xem docs/roadmap/LO-TRINH.md) — vòng tròn săn đuổi CÔNG KHAI: cảnh
