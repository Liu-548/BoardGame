...
Cơ chế "phát 2 lá nhân vật, chọn giữ 1" coi như HOÀN TẤT — core, UI (hotseat + qua mạng), và đồng hồ 30 giây thật đều đã xong và ĐANG BẬT cho ván thật. Còn lại: expansion, house rules, đồ hoạ đẹp (ảnh nhân vật thật trong `public/sprites/characters/`, giống ảnh lá bài — hiện vẫn ô xám vì chưa có file), âm thanh, tài khoản/đăng nhập, bảng xếp hạng.
