...
Biến thể 3 người (xem `LO-TRINH.md`) — 8 người và 2 người đã xong (xem trên). 3 người cần thiết kế mới hoàn toàn (vòng tròn săn đuổi cảnh sát→tội phạm→kẻ phản bội→cảnh sát) — nhiều điểm luật chưa chốt: vai "cảnh sát" có công khai từ đầu như Sheriff không? Mục tiêu săn của mỗi người gán/hiển thị lúc nào? (Cách xác định "ai là người giết" đã có sẵn — `killerId`/`killedBy` — không còn là điểm chưa rõ.)

Cơ chế "phát 2 lá nhân vật, chọn giữ 1" coi như HOÀN TẤT — core, UI (hotseat + qua mạng), và đồng hồ 30 giây thật đều đã xong và ĐANG BẬT cho ván thật. Bia (Beer) cũng đã HOÀN THIỆN — cả ngoại lệ "vô tác dụng khi còn 2 người" lẫn cơ chế "hồi sinh tự động khi máu về 0". Còn lại: 5.3 (house rules), 5.4 (expansion), đồ hoạ đẹp (ảnh nhân vật thật trong `public/sprites/characters/`, giống ảnh lá bài — hiện vẫn ô xám vì chưa có file), âm thanh, tài khoản/đăng nhập, bảng xếp hạng.

Cả 16 nhân vật đã có THẬT trong `core/characters.ts` (việc 5.2, đợt 1-7) VÀ đã chơi được qua giao diện thật (hotseat lẫn qua mạng, kèm đồng hồ hết giờ tự động) — Giai đoạn 5 (phần nhân vật) coi như xong.
