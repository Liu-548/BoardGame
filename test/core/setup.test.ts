...
import { CHARACTERS, EXPANSION_CHARACTER_IDS } from "../../src/games/bang/core/characters";
...
describe("setupGame", () => {
  ...
  it.each([4, 5, 6, 7, 8])("chia đúng số vai với %i người chơi", (playerCount) => {
    ...
    // Biến thể 8 người (xem docs/roadmap/LO-TRINH.md): giống 7 người mặc định, cộng thêm
