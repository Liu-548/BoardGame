...
// crash, 0 ván treo. File này KHÔNG đụng tới src/games/bang/core/ — bot chỉ là công cụ
...
import { cardNameFromId, isDelayedEquipmentCardName, isSelfEquipBlueCardName } from "../../src/games/bang/core/cards";
import { reduce } from "../../src/games/bang/core/reduce";
import { nextRandom } from "../../src/games/bang/core/rng";
import { setupGame } from "../../src/games/bang/core/setup";
import type { Action, GameState, PlayerState } from "../../src/games/bang/core/types";
...
describe("Bot ngẫu nhiên — cột mốc việc 1.14", () => {
  ...
  // Biến thể 2 người (xem docs/roadmap/LO-TRINH.md, setup.ts's isDuelMode()) — không chia
  ...
  // Biến thể 3 người (vòng tròn săn đuổi công khai, xem docs/roadmap/LO-TRINH.md,
