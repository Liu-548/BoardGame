...
// ván, xem GameState.houseRules ở types.ts + docs/roadmap/LO-TRINH.md/CLAUDE.md). Đợt này
...
import type { GameState, HouseRuleId, PlayerState } from "../../src/games/bang/core/types";
